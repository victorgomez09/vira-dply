module github.com/mikrocloud/mikrocloud
...
require (
	...
	// Additional dependencies that will be resolved
...
replace github.com/marcboeker/go-duckdb => github.com/marcboeker/go-duckdb v1.7.1
