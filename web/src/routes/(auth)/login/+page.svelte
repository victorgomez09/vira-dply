...
<svelte:head>
	<title>Login - mikrocloud</title>
	<meta name="description" content="Sign in to mikrocloud" />
</svelte:head>
...
<div class="min-h-screen flex flex-col py-12 px-[85px]">
	<header class="flex items-center justify-between">
		...
		{#if allowRegistrations}
			<button onclick={() => goto('/register')} class="btn btn-outline">Signup</button>
		{/if}
	</header>
	...
	<div class="flex-1 flex items-center justify-center px-4 py-12">
		<div class="w-full max-w-sm space-y-6">
			...
			<form onsubmit={handleSubmit} class="space-y-5">
				...
				<input type="email" bind:value={email} placeholder="email" required autocomplete="email" class="input input-bordered w-full" />
